...
namespace TodoDB.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemID,ItemName,ListID,DueDate,Details,Done")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemID,ItemName,ListID,DueDate,Details,Done")] Item item)
        {
            if (ModelState.IsValid)
            {
